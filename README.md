...
### 环境要求
- Node.js >= 18.x（推荐 v18+，兼容 v24）
- npm >= 9.x
- **无需** Visual Studio 或任何 C++ 编译工具
...
**注意**：本项目使用纯 JavaScript 数据库（sql.js），无需编译任何原生模块，因此不需要安装 Visual Studio、Python 或其他 C++ 编译工具。
...
- **Vite 5**: 快速的前端构建工具
- **sql.js**: 纯 JavaScript 实现的 SQLite（零原生依赖）
